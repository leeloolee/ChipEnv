...
from chipenv import coordinate_descent_placer as cd_placer
from chipenv import observation_config
from chipenv import observation_extractor
from chipenv import placement_util
from chipenv import plc_client
import gin
import gym
import numpy as np
...
class CircuitEnv(gym.Env):
  ...
  def get_static_obs(self):
    """Get the static observation for the chipenv.
...
def create_circuit_environment(*args, **kwarg) -> wrappers.ActionClipWrapper:
  """Create an `CircuitEnv` wrapped as a Gym chipenv.
